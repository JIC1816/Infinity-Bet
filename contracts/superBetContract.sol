...
contract superBetContract is EnetscoresConsumer, KeeperCompatibleInterface {
    uint public lastTimeStamp;
    uint public interval = 500 seconds;
    address public owner;
    address tokenAddress;
    EnetscoresConsumer private consumer;
    bytes32 _specId =
        0x6431313062356334623833643432646361323065343130616335333763643934;
    uint256 _payment = 100000000000000000;
    uint256 _market = 0;
    uint256 _leagueId = 47;
    uint256 _date = lastTimeStamp;
    ...
    constructor(address _tokenAddress, uint updateInterval) {
        owner = msg.sender;
